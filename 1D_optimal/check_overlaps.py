...
def intersect_index(t, p1, p2, params):
   return (growth(t, p1["species"], p1["t"], params)+growth(t, p2["species"], p2["t"], params))-np.abs(p1["x"]-p2["x"])
...
def close_space(p1, p2, params):
    return np.abs(p1["x"]-p2["x"])<(params["R"][p1['species']]+params["R"][p2['species']])
